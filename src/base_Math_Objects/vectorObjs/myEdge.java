package base_Math_Objects.vectorObjs;
...
public class myEdge {
	...
	public myEdge(IRenderInterface p2){this(p2,new myPoint(0,0,0),new myPoint(0,0,0));}
	public myEdge(IRenderInterface _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}
