...
public class myCntlPtf extends myPointf {
	...
	public void drawMe(IRenderInterface pa, int cIdx, boolean flat){	pa.setFill(clr[cIdx],clr[cIdx][3]);  pa.setStroke(clr[cIdx],clr[cIdx][3]);		pa.show(this,2,-1,-1, flat);}		
	public void drawRad(IRenderInterface pa, int cIdx,myVectorf I, myVectorf J){
        pa.setFill(clr[cIdx],clr[cIdx][3]);  
        pa.setStroke(clr[cIdx],clr[cIdx][3]); 
        pa.drawCircle(this, r, I,J,20);
    }
	public void drawRad(IRenderInterface pa, myVectorf I, myVectorf J){
        pa.drawCircle(this, r, I,J,20);
    }
	public void drawBall(IRenderInterface pa, int cIdx,myVectorf I, myVectorf J) {
	...
	public void drawNorm(IRenderInterface pa, int cIdx,myVectorf I, myVectorf J) {
